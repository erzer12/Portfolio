...
function SortableTestimonialCard({
	...
	return (
		<div
			ref={setNodeRef}
			style={style}
			className="flex items-start gap-4 border border-[--rule] p-4 bg-[--bg]"
		>
			<div
				{...attributes}
				{...listeners}
				className="cursor-grab text-[--ink-faint] hover:text-[--ink] active:cursor-grabbing pt-1"
			>
				☰
			</div>
								...
								<div className="flex items-start justify-between gap-4">
									...
									<div className="flex gap-2">
										...
										<button
											...
											className="admin-btn-sm !border-green-400 !text-green-700"
										>
											Approve
										</button>
										{/* Fixed: Added explicit type="button" */}
