			...
			<div className="space-y-12 py-10">
				...
				{(() => {
					...
					if (achievements.length > 0)
						items.push({ id: 'section-achievements', label: 'Achievements' });
					if (certifications.length > 0)
						items.push({ id: 'section-certs', label: 'Certifications' });
					if (settings?.show_testimonials && testimonials.length > 0)
						items.push({ id: 'section-testimonials', label: 'Testimonials' });
