			...
			{!confirming ? (
				...
				<div className="flex-1">
					<div className="rounded bg-yellow-900/20 border border-yellow-700 p-3">
						<p className="font-mono text-sm text-yellow-200 mb-2">
							Warning: This will permanently DELETE existing portfolio content and replace it with
							seed data.
						</p>
						<label className="flex items-center gap-2">
							...
							<span className="text-xs text-[--ink-muted]">
								I understand this will wipe data and I want to proceed.
							</span>
						</label>
						<div className="mt-2 flex gap-2">
							...
							<button type="button" onClick={() => setConfirming(false)} className="admin-btn-sm">
								Cancel
							</button>
						</div>
					</div>
