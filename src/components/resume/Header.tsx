	...
	return (
		<section className="grid gap-6 md:grid-cols-[1fr_120px] md:items-start">
			<div className="space-y-4">
				<div>
					<p className="font-serif text-5xl italic text-[--ink-bright] md:text-6xl">
						{displayText(name)}
					</p>
			...
			{image ? (
				<div className="relative h-[160px] w-[160px] aspect-square overflow-hidden border border-[--rule]">
				...
				<div
					className="h-[180px] w-[180px] aspect-square border border-[--rule] bg-[--bg] flex items-center justify-center"
					aria-hidden="true"
				>
					<svg
						width="36"
					...
					>
						...
						<path
							d="M12 12c1.656 0 3-1.344 3-3s-1.344-3-3-3-3 1.344-3 3 1.344 3 3 3z"
							stroke="currentColor"
							opacity="0.12"
						/>
					</svg>
